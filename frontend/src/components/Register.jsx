      ...
      <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
              <div className='mb-4'>
                  ...
                  type="email" name='email' placeholder='Email Address' className='shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow' />
              </div>
              <div className='mb-4'>
          ...
          <p className='align-baseline font-md mt-4 text-sm'>Already have an account? <Link to="/login" className='text-blue-500 hover:text-blue-700'> Login</Link></p>
          {/* Google auth */}
          <div className='mt-4'>
            <button 
